...
//liyunfan5@huaqin.com,10/13/2020,merge mtk modified methond:modified tip music of headset
...
#ifdef VENDOR_EDIT
 /* RM.MM.AudioDriver.wangkun add for cancel getting headphone impedance */
enum impedance_get {
	NOT_GET_IMPEDANCE,
};
static unsigned int accdec_hp_impedance_get;
#endif /*VENDOR_EDIT*/
			    ...
			    struct snd_ctl_elem_value *ucontrol)
{
    #ifdef VENDOR_EDIT
     /* RM.MM.AudioDriver.wangkun add for cancel getting headphone impedance */
    if (accdec_hp_impedance_get == NOT_GET_IMPEDANCE) {
        pr_info("%s(),cancel getting hp_impedance\n", __func__);
        return 0;
    }
    #endif /*VENDOR_EDIT*/
