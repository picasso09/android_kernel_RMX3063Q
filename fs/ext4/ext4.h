...
#ifdef CONFIG_OPLUS_FEATURE_EXT4_DEFRAG
/* yanwu@TECH.Storage.FS.EXT4, 2020/02/29, support move_extent if ICE */
#ifndef IS_ENCRYPTED
#define IS_ENCRYPTED(inode) ext4_encrypted_inode(inode)
#endif
//static inline bool ext4_using_software_encryption(struct inode *inode)
//{
//	return IS_ENCRYPTED(inode) && !fscrypt_using_hardware_encryption(inode);
//}
#endif
