...
//static struct wake_lock fp_wakelock; //4.14
static struct wakeup_source fp_wakelock; //4.9
...
#endif
{
    ...
    pr_err("%s, liangliang gf_parse_dts success \n", __func__);
...
static int __init gf_init(void)
{
    ...
    if(1 == sim_val){
        printk("%s, Need to register Goodix3688 FP driver\n", __func__);
    } else {
        printk("%s, Don't need to register Goodix3688 FP driver\n", __func__);
        return -1;
    }
