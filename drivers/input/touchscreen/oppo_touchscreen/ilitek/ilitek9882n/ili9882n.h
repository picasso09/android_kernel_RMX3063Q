...
#define DRIVER_VERSION			"3.0.2.0.200423"
...
#define DTS_OF_NAME	"tchip,tp_oppo6765"
...
struct ilitek_ts_data {
    ...
    struct firmware_headfile *p_firmware_headfile;/*for ili firmware*/
    tp_dev tp_type;
    char *fw_name;
...
extern int ili_mp_test_main(char *apk, bool lcm_on, struct seq_file *s, char *message);
...
extern int ili_mp_test_handler(char *apk, bool lcm_on, struct seq_file *s, char *message);
