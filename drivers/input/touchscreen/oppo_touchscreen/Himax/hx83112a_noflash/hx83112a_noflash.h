...
struct touchpanel_data *hx83112a_private_ts;
int hx83112a_g_f_0f_updat = 0;

/**COMMON USE   ***START***/
unsigned long hx83112a_FW_VER_MAJ_FLASH_ADDR;
unsigned long hx83112a_FW_VER_MIN_FLASH_ADDR;
unsigned long hx83112a_CFG_VER_MAJ_FLASH_ADDR;
unsigned long hx83112a_CFG_VER_MIN_FLASH_ADDR;
unsigned long hx83112a_CID_VER_MAJ_FLASH_ADDR;
unsigned long hx83112a_CID_VER_MIN_FLASH_ADDR;
unsigned long hx83112a_FW_VER_MAJ_FLASH_LENG;
unsigned long hx83112a_FW_VER_MIN_FLASH_LENG;
unsigned long hx83112a_CFG_VER_MAJ_FLASH_LENG;
unsigned long hx83112a_CFG_VER_MIN_FLASH_LENG;
unsigned long hx83112a_CID_VER_MAJ_FLASH_LENG;
unsigned long hx83112a_CID_VER_MIN_FLASH_LENG;
unsigned long hx83112a_FW_CFG_VER_FLASH_ADDR;
uint8_t hx83112a_HX_PROC_SEND_FLAG;

struct proc_dir_entry *hx83112a_himax_proc_register_file = NULL;
uint8_t hx83112a_byte_length = 0;
uint8_t hx83112a_register_command[4];
bool hx83112a_cfg_flag = false;

//#ifdef HX_ESD_RECOVERY
u8 hx83112a_HX_ESD_RESET_ACTIVATE = false;
int hx83112a_hx_EB_event_flag;
int hx83112a_hx_EC_event_flag;
int hx83112a_hx_ED_event_flag;
//#endif

bool hx83112a_HX_RESET_STATE;

unsigned char hx83112a_IC_TYPE = 11;
unsigned char hx83112a_IC_CHECKSUM = 0;
bool hx83112a_DSRAM_Flag = false;
int hx83112a_g_diag_command = 0;
uint8_t hx83112a_diag_coor[128];
int32_t hx83112a_diag_self[100] = {0};

int hx83112a_g_max_mutual = 0;
int hx83112a_g_min_mutual = 255;
int hx83112a_g_max_self = 0;
int hx83112a_g_min_self = 255;

int hx83112a_mutual_set_flag;
uint8_t hx83112a_cmd_set[8];
...
char *g_hx83112a_inspection_mode[] = {
    "HIMAX_INSPECTION_OPEN",
    "HIMAX_INSPECTION_MICRO_OPEN",
    "HIMAX_INSPECTION_SHORT",
    "HIMAX_INSPECTION_RAWDATA",
...
/* for criteria */
char *hx83112a_g_hx_inspt_crtra_name[] = {
    "CRITERIA_OPEN_MIN",
    "CRITERIA_OPEN_MAX",
...
struct chip_data_hx83112b {
    ...
    struct workqueue_struct  *hx83112a_0f_update_wq;
