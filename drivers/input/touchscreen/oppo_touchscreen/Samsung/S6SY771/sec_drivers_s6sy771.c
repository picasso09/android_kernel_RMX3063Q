...
struct chip_data_s6sy771 *g_chip_info;
...
int sec_read_calibration_report(struct chip_data_s6sy771 *chip_info)
{
    int ret;
    u8 buf[5] = { 0 };
...
int sec_execute_force_calibration(struct chip_data_s6sy771 *chip_info)
{
    int rc = -1;
...
int sec_fix_tmode(struct chip_data_s6sy771 *chip_info, u8 mode, u8 state)
{
    int ret = -1;
...
int sec_release_tmode(struct chip_data_s6sy771 *chip_info)
{
    int ret = -1;
...
int sec_execute_p2ptest(struct seq_file *s, struct chip_data_s6sy771 *chip_info, struct sec_testdata *sec_testdata)
{
    int rc;
