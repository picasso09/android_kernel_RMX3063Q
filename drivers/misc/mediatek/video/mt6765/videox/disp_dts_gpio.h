...
/* DTS state */
/* wangcheng@ODM.Multimedia.LCD  2020/09/07 add  for lcd  bringup  start  */
#ifdef CONFIG_LCD_GPIO_FROM_DTS
enum DTS_GPIO_STATE {
...
#endif
/* wangcheng@ODM.Multimedia.LCD  2020/09/07 add  for lcd  bringup end */
