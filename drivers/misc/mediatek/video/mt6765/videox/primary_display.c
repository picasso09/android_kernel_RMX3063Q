...
#ifdef MTK_FB_MMDVFS_SUPPORT
#ifdef ODM_HQ_EDIT
/* wangcheng@MM.Display.LCD.Stability, 2020/09/27, add project choose*/
...
#ifdef ODM_HQ_EDIT
/* Xiaojun.Lv@MM.Lcd.Driver, 2020/10/14, modify timing for nt36525b */
...
/*
* Yongpeng.Yi@PSW.MM.Display.LCD.Stability, 2018/01/16, start
...
/*
* Yongpeng.Yi@PSW.MM.Display.LCD.Machine, 2018/01/26, end
...
/* wangcheng@ODM.Multimedia.LCD  2020/12/20 Add double framebuff from MTK start */
#ifdef ODM_HQ_EDIT
static UINT32 disp_fb_pages = 4;
/* wangcheng@ODM.Multimedia.LCD  2020/12/20 Add double framebuff from MTK end */
#endif
