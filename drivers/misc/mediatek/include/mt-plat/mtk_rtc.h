...
/*Liu.Yong@RM.CM.BSP.CHG.Basic 2020.05.15 add monitic soc for RTC*/
extern int get_rtc_spare_monitic_soc_value(void);
extern int set_rtc_spare_monitic_soc_value(int val);
