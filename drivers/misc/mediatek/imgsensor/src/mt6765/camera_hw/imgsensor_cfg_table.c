...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_20701_BC[] = {
	{
...
struct IMGSENSOR_HW_CFG imgsensor_custom_config_20701_A[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
		{
...
#ifdef ODM_HQ_EDIT
/*Pengfei.Zhao@ODM 20200902 add for RIO bringup for RIO A&B&C compatible*/
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_20701_BC[] = {
...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence_20701_A[] = {
#if defined(HI846_MIPI_RAW)
		{
			SENSOR_DRVNAME_HI846_MIPI_RAW,
			{
