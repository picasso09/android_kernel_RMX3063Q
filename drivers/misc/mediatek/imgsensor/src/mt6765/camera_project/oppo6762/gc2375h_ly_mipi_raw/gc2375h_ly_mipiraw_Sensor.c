...
#include "gc2375h_ly_mipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "gc2375h_ly_camera_sensor"
#define LOG_1 LOG_INF("GC2375H_LY_,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)

#define GC2375H_LY_MIPI_USE_OTP

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool GC2375H_LY_DuringTestPattern = KAL_FALSE;

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2375H_LY_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
    ...
    .i2c_addr_table = {0x2e, 0x7a, 0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
};
...
#ifdef GC2375H_LY_MIPI_USE_OTP

typedef struct otp_gc2375h_ly_{
	kal_uint16 wb_flag;
	kal_uint16 r_gain;
	kal_uint16 g_gain;
	kal_uint16 b_gain;
...
static gc2375h_ly_otp gc2375h_ly_otp_info;
...
static kal_uint8 gc2375h_ly_read_otp(kal_uint8 addr)
{
	kal_uint8 value;
...
static void gc2375h_ly_gcore_read_otp_info(void)
{
	kal_uint8 flag;
	memset(&gc2375h_ly_otp_info,0,sizeof(gc2375h_ly_otp));

	flag = gc2375h_ly_read_otp(0x00);
	LOG_INF("GC2375H_LY_OTP : flag = 0x%x\n",flag);

	gc2375h_ly_otp_info.wb_flag = flag&0x03;
	gc2375h_ly_otp_info.ob_flag = (flag>>2)&0x03;

	/*WB*/
	if(0x01==gc2375h_ly_otp_info.wb_flag)
	{
		LOG_INF("GC2375H_LY_OTP_WB:Valid");
		/*
		gc2375h_ly_otp_info.r_gain = (gc2375h_ly_read_otp(0x08)<<3)|(gc2375h_ly_read_otp(0x20)&0x07);
		gc2375h_ly_otp_info.g_gain = (gc2375h_ly_read_otp(0x10)<<3)|((gc2375h_ly_read_otp(0x20)>>4)&0x07);
		gc2375h_ly_otp_info.b_gain = (gc2375h_ly_read_otp(0x18)<<3)|(gc2375h_ly_read_otp(0x28)&0x07);
		*/
		gc2375h_ly_otp_info.r_gain = gc2375h_ly_read_otp(0x08);
		gc2375h_ly_otp_info.g_gain = gc2375h_ly_read_otp(0x10);
		gc2375h_ly_otp_info.b_gain = gc2375h_ly_read_otp(0x18);
		gc2375h_ly_otp_info.g_r_gain_l= gc2375h_ly_read_otp(0x20);
		gc2375h_ly_otp_info.b_g_gain_l= gc2375h_ly_read_otp(0x28);

		LOG_INF("GC2375H_LY_OTP_WB:r_gain=0x%x\n",gc2375h_ly_otp_info.r_gain);
		LOG_INF("GC2375H_LY_OTP_WB:g_gain=0x%x\n",gc2375h_ly_otp_info.g_gain);
		LOG_INF("GC2375H_LY_OTP_WB:b_gain=0x%x\n",gc2375h_ly_otp_info.b_gain);
		LOG_INF("GC2375H_LY_OTP_WB:g_r_gain_l=0x%x\n",gc2375h_ly_otp_info.g_r_gain_l);
		LOG_INF("GC2375H_LY_OTP_WB:b_g_gain_l=0x%x\n",gc2375h_ly_otp_info.b_g_gain_l);
	}
	else
	{
		LOG_INF("GC2375H_LY_OTP_WB:Invalid!");
	}

	/*OB*/
	if(0x01==gc2375h_ly_otp_info.ob_flag)
	{
		LOG_INF("GC2375H_LY_OTP_OB:Valid");
		/*
		gc2375h_ly_otp_info.g1_slope = ((gc2375h_ly_read_otp(0x50)&0x01)<<8)|(gc2375h_ly_read_otp(0x30));
		gc2375h_ly_otp_info.r1_slope = ((gc2375h_ly_read_otp(0x50)&0x02)<<7)|(gc2375h_ly_read_otp(0x38));
		gc2375h_ly_otp_info.b2_slope = ((gc2375h_ly_read_otp(0x50)&0x04)<<6)|(gc2375h_ly_read_otp(0x40));
		gc2375h_ly_otp_info.g2_slope = ((gc2375h_ly_read_otp(0x50)&0x08)<<5)|(gc2375h_ly_read_otp(0x48));
		*/
		gc2375h_ly_otp_info.g1_slope = gc2375h_ly_read_otp(0x30);
		gc2375h_ly_otp_info.r1_slope = gc2375h_ly_read_otp(0x38);
		gc2375h_ly_otp_info.b2_slope = gc2375h_ly_read_otp(0x40);
		gc2375h_ly_otp_info.g2_slope =  gc2375h_ly_read_otp(0x48);
		gc2375h_ly_otp_info.ob_slope =  gc2375h_ly_read_otp(0x50);

		LOG_INF("GC2375H_LY_OTP_OB:g1_slope=0x%x\n",gc2375h_ly_otp_info.g1_slope);
		LOG_INF("GC2375H_LY_OTP_OB:r1_slope=0x%x\n",gc2375h_ly_otp_info.r1_slope);
		LOG_INF("GC2375H_LY_OTP_OB:b2_slope=0x%x\n",gc2375h_ly_otp_info.b2_slope);
		LOG_INF("GC2375H_LY_OTP_OB:g2_slope=0x%x\n",gc2375h_ly_otp_info.g2_slope);
		LOG_INF("GC2375H_LY_OTP_OB:ob_slope=0x%x\n",gc2375h_ly_otp_info.ob_slope);
	}
	else
	{
		LOG_INF("GC2375H_LY_OTP_OB:Invalid!");
	}

}

static void gc2375h_ly_gcore_update_wb(void)
{
	if(0x01==gc2375h_ly_otp_info.wb_flag)
	{
		write_cmos_sensor(0xfe,0x00);
		write_cmos_sensor(0xb8,gc2375h_ly_otp_info.g_gain);
		write_cmos_sensor(0xb9,gc2375h_ly_otp_info.r_gain);
		write_cmos_sensor(0xba,gc2375h_ly_otp_info.b_gain);
		write_cmos_sensor(0xbb,gc2375h_ly_otp_info.g_gain);
		write_cmos_sensor(0xbe,gc2375h_ly_otp_info.g_r_gain_l);
		write_cmos_sensor(0xbf,gc2375h_ly_otp_info.b_g_gain_l);
		write_cmos_sensor(0xfe,0x00);
	}
}

static void gc2375h_ly_gcore_update_ob(void)
{
	if(0x01==gc2375h_ly_otp_info.ob_flag)
	{
		write_cmos_sensor(0xfe,0x01);
		write_cmos_sensor(0x41,gc2375h_ly_otp_info.g1_slope);
		write_cmos_sensor(0x42,gc2375h_ly_otp_info.r1_slope);
		write_cmos_sensor(0x43,gc2375h_ly_otp_info.b2_slope);
		write_cmos_sensor(0x44,gc2375h_ly_otp_info.g2_slope);
		write_cmos_sensor(0x45,gc2375h_ly_otp_info.ob_slope);
		write_cmos_sensor(0xfe,0x00);
	}

}

static void gc2375h_ly_gcore_update_otp(void)
{
	gc2375h_ly_gcore_update_wb();
	gc2375h_ly_gcore_update_ob();
}

static void gc2375h_ly_gcore_enable_otp(otp_state state)
{
	...
	if(state)
	{
		...
		LOG_INF("GC2375H_LY_OTP: Enable OTP!\n");
	}
	else
	{
		otp_en = otp_en & 0x7f;
		...
		LOG_INF("GC2375H_LY_OTP: Disable OTP!\n");
	}

}

void gc2375h_ly_gcore_identify_otp(void)
{
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xfe, 0x00);
	...
	gc2375h_ly_gcore_enable_otp(otp_open);
	gc2375h_ly_gcore_read_otp_info();
	gc2375h_ly_gcore_enable_otp(otp_close);
}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if((ANALOG_GAIN_1<= iReg)&&(iReg < ANALOG_GAIN_2))
	{
		...
		LOG_INF("GC2375H_LY_MIPI analogic gain 1x, GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_2<= iReg)&&(iReg < ANALOG_GAIN_3))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 1.43x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_3<= iReg)&&(iReg < ANALOG_GAIN_4))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 2x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_4<= iReg)&&(iReg < ANALOG_GAIN_5))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 2.84x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_5<= iReg)&&(iReg < ANALOG_GAIN_6))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 3.97x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_6<= iReg)&&(iReg < ANALOG_GAIN_7))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 5.68x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_7<= iReg)&&(iReg < ANALOG_GAIN_8))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 8.14x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else if((ANALOG_GAIN_8<= iReg)&&(iReg < ANALOG_GAIN_9))
	{
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 11.34x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
	else
	{
		write_cmos_sensor(0x20,0x0c);
		...
		write_cmos_sensor(0xb1,temp>>6);
		write_cmos_sensor(0xb2,(temp<<2)&0xfc);
		LOG_INF("GC2375H_LY_MIPI analogic gain 16.23x , GC2375H_LY_MIPI add pregain = %d\n",temp);
	}
...
static kal_uint32 open(void)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    GC2375H_LY_DuringTestPattern = KAL_FALSE;
...
UINT32 GC2375H_LY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
