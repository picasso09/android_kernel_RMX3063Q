...
static imgsensor_info_struct imgsensor_info = {
	...
	.custom1 = {
		...
		/* following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 240,
		.mipi_pixel_rate = 321600000,   /*Wujun@RM.Camera add for dualcam can't open 20200709*/
	},
...
#ifdef VENDOR_EDIT
    //wangzezhi@hq 20190412 add for long exp n+1 or n+2
...
UINT32 S5K3L6_MIPI_RAW_SensorInit(struct PSENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL) {
		*pfFunc=&sensor_func;
	}
