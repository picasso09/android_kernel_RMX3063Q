...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .linelength = 1026,            //record different mode's linelength
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6]={
    ...
    {  1600, 1200,  0, 0, 1600, 1200, 1600, 1200,
       0000, 0000, 1600, 1200,  0, 0, 1600, 1200}, //24fps for dual camera Custom1
};
...
static void sensor_init(void)
{
...

    {
        ...
        write_cmos_sensor(0x04,0x76);
        write_cmos_sensor(0x09,0x00);
        write_cmos_sensor(0x0a,0x28);//88
        ...
        write_cmos_sensor(0x66,0xa6);
        write_cmos_sensor(0x68,0xa8);
