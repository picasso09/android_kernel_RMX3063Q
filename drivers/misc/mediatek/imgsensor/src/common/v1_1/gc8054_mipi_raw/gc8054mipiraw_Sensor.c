...
static void set_shutter(kal_uint32 shutter)
{
	...
	write_cmos_sensor_16(0x0202, cal_shutter & 0xfffe);
	#else
	if (shutter >= 0xFFEE) {
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0320,0xbb);
	write_cmos_sensor(0x0337,0x05);
	write_cmos_sensor(0x0335,0x59);
	write_cmos_sensor(0x0336,0x92);
	write_cmos_sensor(0x031a,0x01);
	write_cmos_sensor(0x0321,0x10);
	write_cmos_sensor(0x0327,0x05);
	write_cmos_sensor(0x0325,0x43);
	write_cmos_sensor(0x0326,0x54);
	write_cmos_sensor(0x0314,0x01);
	...
	write_cmos_sensor(0x0255,0x21);
	write_cmos_sensor(0x0280,0x38);
	write_cmos_sensor(0x021f,0x18);
	write_cmos_sensor(0x0224,0x41);
	write_cmos_sensor(0x0234,0x20);
	write_cmos_sensor(0x024a,0x04);
	write_cmos_sensor(0x039a,0xc0);
	write_cmos_sensor(0x031c,0x80);
	write_cmos_sensor(0x03fe,0x10);
	write_cmos_sensor(0x03fe,0x00);
	write_cmos_sensor(0x031c,0x9f);
	...
	write_cmos_sensor(0x0121,0x02);
	write_cmos_sensor(0x0122,0x03);
	write_cmos_sensor(0x0123,0x09);
	write_cmos_sensor(0x0124,0x00);
	write_cmos_sensor(0x0125,0x08);
	write_cmos_sensor(0x0126,0x05);
	write_cmos_sensor(0x0129,0x03);
	write_cmos_sensor(0x012a,0x03);
	write_cmos_sensor(0x012b,0x05);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x0185,0x01);
	write_cmos_sensor(0x0188,0x00);
	write_cmos_sensor(0x0121,0x0b);
	write_cmos_sensor(0x0122,0x0d);
	write_cmos_sensor(0x0123,0x2f);
	write_cmos_sensor(0x0124,0x01);
	write_cmos_sensor(0x0125,0x12);
	write_cmos_sensor(0x0126,0x0f);
	write_cmos_sensor(0x0129,0x0c);
	write_cmos_sensor(0x012a,0x13);
	write_cmos_sensor(0x012b,0x0f);
	write_cmos_sensor(0x0a70,0x11);
	write_cmos_sensor(0x0313,0x80);
	write_cmos_sensor(0x0aff,0x10);
	write_cmos_sensor(0x0aff,0x10);
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0x0345,0xe6);
	write_cmos_sensor(0x0346,0x01);
	write_cmos_sensor(0x0347,0x6c);
	write_cmos_sensor(0x0348,0x09);
	write_cmos_sensor(0x0349,0x10);
	write_cmos_sensor(0x034a,0x06);
	write_cmos_sensor(0x034b,0xcc);
	write_cmos_sensor(0x0291,0x05);
	write_cmos_sensor(0x0292,0x94);
	write_cmos_sensor(0x0213,0x12);
	write_cmos_sensor(0x02a9,0x18);
	write_cmos_sensor(0x0221,0x22);
	write_cmos_sensor(0x028b,0x18);
	...
	write_cmos_sensor(0x03fe,0x00);
	write_cmos_sensor(0x031c,0x9f);
	write_cmos_sensor(0x00d3,0x68);
	write_cmos_sensor(0x00d4,0x01);
	write_cmos_sensor(0x00d5,0xe0);
	write_cmos_sensor(0x00d6,0x01);
	write_cmos_sensor(0x05a0,0x83);
	write_cmos_sensor(0x05a3,0x06);
	write_cmos_sensor(0x05a4,0x04);
	write_cmos_sensor(0x0597,0x27);
