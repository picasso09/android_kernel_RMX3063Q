...
//Zezhi.Wang@ODM_HQ.Camera.Driver. 20190129 add for shuimitao
	...
	{GC02M1B_SW_SENSOR_ID,
	SENSOR_DRVNAME_GC02M1B_SW_MIPI_RAW,
	GC02M1B_SW_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1_MIPI_RAW)
	{GC02M1_RIO_SENSOR_ID,
