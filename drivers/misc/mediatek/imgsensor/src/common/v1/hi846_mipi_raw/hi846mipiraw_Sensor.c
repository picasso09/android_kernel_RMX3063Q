...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.hs_video = {
		...
		.max_framerate = 900,
		.mipi_pixel_rate = 144000000, //(180M*4/10)
	},
	.slim_video = {
		.pclk = 288000000,
		.linelength = 3800,
		...
		.mipi_data_lp2hs_settle_dc = 85,//unit , ns
		.max_framerate = 1200,
		.mipi_pixel_rate = 72000000, //(360M*4/10)
	},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
 ...
 { 3280, 2448,   0, 504,   3264, 1440,   1632,  720, 176, 0, 1280,  720,   0, 0, 1280, 720 }, //hight speed video
 { 3264, 2448,   0, 264,   3264, 1920,    816, 1920,  88, 0,  640,  480,   0, 0,  640, 480 },
};// slim video
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_HI846, imgsensor_info.module_id);
