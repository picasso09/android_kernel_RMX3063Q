...
#include "gc02m1b_sw_mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc02m1b_sw_camera_sensor"
...
#define DEVICE_VERSION_GC02M1B_SW    "gc02m1b_sw"
static kal_uint8 deviceInfo_register_value = 0x00;

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1B_SW_SENSOR_ID,
...
static kal_uint16 addr_data_pair_sw_init_gc02m1b[] = {
...
static kal_uint16 addr_data_pair_sw_preview_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_sw_capture_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_sw_normal_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_sw_hs_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_sw_slim_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_sw_hlt_custom1_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x06,
	0x42, 0x3a,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_sw_hlt_custom2_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static void sensor_init(void)
{
	...
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_init_gc02m1b,
		sizeof(addr_data_pair_sw_init_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_preview_gc02m1b,
		sizeof(addr_data_pair_sw_preview_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_capture_gc02m1b,
		sizeof(addr_data_pair_sw_capture_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_normal_video_gc02m1b,
		sizeof(addr_data_pair_sw_normal_video_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_hs_video_gc02m1b,
		sizeof(addr_data_pair_sw_hs_video_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_slim_video_gc02m1b,
		sizeof(addr_data_pair_sw_slim_video_gc02m1b) /
		sizeof(kal_uint16));
}
static void custom1_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_hlt_custom1_gc02m1b,
		sizeof(addr_data_pair_sw_hlt_custom1_gc02m1b) /
		sizeof(kal_uint16));
}
static void custom2_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_sw_hlt_custom2_gc02m1b,
		sizeof(addr_data_pair_sw_hlt_custom2_gc02m1b) /
		sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = (return_sensor_id());
			...
			if (*sensor_id == GC02M1B_SW_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				/*Pengfei.Zhao@Camera.DRV add for register device info 20201028*/
				imgsensor_info.module_id = 0x5D;
				if (deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_r3", DEVICE_VERSION_GC02M1B_SW, imgsensor_info.module_id);
...
UINT32 GC02M1B_SW_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
