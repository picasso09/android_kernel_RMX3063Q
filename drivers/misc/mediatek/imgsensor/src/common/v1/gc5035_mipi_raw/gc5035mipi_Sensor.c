...
#define DEVICE_VERSION_GC5035    "gc5035"
...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .cap = {
        .pclk = 175200000,
        .linelength = 2920,
        .framelength = 2064, //stephen vb2ms
        .startx = 0,
        .starty = 0,
    ...
    .cap1 = {
        ...
        .pclk = 141600000,
        .linelength = 2920,
        .framelength = 2041, //stephen vb2ms
        .startx = 0,
        .starty = 0,
        .grabwindow_width = 2592,
        .grabwindow_height = 1944,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
    ...
    { 2592, 1944,  16, 252, 2560, 1440, 2560, 1440, 0, 0, 2560, 1440, 0, 0, 2560, 1440 },  //normal_video
    { 2592, 1944,  16, 252, 2560, 1440, 1280,  720, 0, 0, 1280,  720, 0, 0, 1280,  720 },
    { 2592, 1944,  16, 252, 2560, 1440, 1280,  720, 0, 0, 1280,  720, 0, 0, 1280,  720 }   //slim_video
};
        ...
        do {
            *sensor_id = return_sensor_id();
			...
			if (deviceInfo_register_value == 0x00) {
				register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_GC5035, imgsensor_info.module_id);
