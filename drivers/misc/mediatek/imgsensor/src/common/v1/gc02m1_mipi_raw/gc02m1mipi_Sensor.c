...
#define MACRO_MODULE_FLAG_OFFSET 0X01
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_RIO_SENSOR_ID,
...
static kal_uint16 is_first_flag(void)
{
	kal_uint16 get_byte=0;
	char pusendcmd[2] = {(char)(MACRO_MODULE_FLAG_OFFSET >> 8) , (char)(MACRO_MODULE_FLAG_OFFSET & 0xFF) };
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	if (is_first_flag() != 1){
		*sensor_id = 0xFFFFFFFF;
		printk("please check otp or gc02m1 position! \n");
