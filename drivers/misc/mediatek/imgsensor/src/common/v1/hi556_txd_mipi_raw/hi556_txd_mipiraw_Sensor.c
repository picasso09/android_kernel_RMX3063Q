...
#include "hi556_txd_mipiraw_Sensor.h"

#define PFX "hi556_txd_camera_sensor"
...
#define DEVICE_VERSION_HI556_TXD    "hi556_txd"
...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .framelength = 1986,            //record different mode's framelength
        ...
        .max_framerate = 300,
        .mipi_pixel_rate = 168000000,//880M x 2 / 10
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] ={
 ...
 { 2592, 1944, 16,   252,  2560, 1440,   2560, 1440,   0, 0, 2560, 1440,   0, 0, 2560, 1440},     // video
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_txd_init_hi556[] = {
    0x0e00, 0x0102,
    0x0e02, 0x0102,
    0x0e0c, 0x0100,
    0x2000, 0x7400,
...
static void sensor_init(void)
{
    ...
    hi556_table_write_cmos_sensor(
        addr_data_pair_txd_init_hi556,
        sizeof(addr_data_pair_txd_init_hi556) /
        sizeof(kal_uint16));
#else
    ...
    write_cmos_sensor(0x095a, 0x514e);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_txd_preview_hi556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6925,
    0x0f32, 0x7067,
    0x004a, 0x0100,
...
#if MULTI_WRITE
    hi556_table_write_cmos_sensor(
        addr_data_pair_txd_preview_hi556,
        sizeof(addr_data_pair_txd_preview_hi556) /
        sizeof(kal_uint16));
#else
    write_cmos_sensor(0x0b0a, 0x8252);
    write_cmos_sensor(0x0f30, 0x6925);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_txd_capture_fps_hi556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6925,
    0x0f32, 0x7067,
    0x004a, 0x0100,
...
kal_uint16 addr_data_pair_txd_capture_30fps_hi556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6925,
    0x0f32, 0x7067,
    0x004a, 0x0100,
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    if (currefps == 300) {
    hi556_table_write_cmos_sensor(
        addr_data_pair_txd_capture_30fps_hi556,
        sizeof(addr_data_pair_txd_capture_30fps_hi556) /
        sizeof(kal_uint16));
    } else {
    hi556_table_write_cmos_sensor(
        addr_data_pair_txd_capture_fps_hi556,
        sizeof(addr_data_pair_txd_capture_fps_hi556) /
        sizeof(kal_uint16));
    }
#else
    if (currefps == 300) {
...
//===============================================
        ...
        write_cmos_sensor(0x0030, 0x1111);
        write_cmos_sensor(0x0032, 0x1111);
        write_cmos_sensor(0x0006, 0x0f89);
        write_cmos_sensor(0x0a22, 0x0000);
        write_cmos_sensor(0x0a12, 0x0a20);
        write_cmos_sensor(0x0a14, 0x0798);
        write_cmos_sensor(0x003e, 0x0000);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_txd_normal_video_hi556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6e25,
    0x0f32, 0x7067,
    0x004a, 0x0100,
...
#if MULTI_WRITE
hi556_table_write_cmos_sensor(
        addr_data_pair_txd_normal_video_hi556,
        sizeof(addr_data_pair_txd_normal_video_hi556) /
        sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_txd_hs_video_hi556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6925,
    0x0f32, 0x7067,
    0x004a, 0x0100,
...
#if MULTI_WRITE
    hi556_table_write_cmos_sensor(
        addr_data_pair_txd_hs_video_hi556,
        sizeof(addr_data_pair_txd_hs_video_hi556) /
        sizeof(kal_uint16));
#else
    write_cmos_sensor(0x0b0a, 0x8252);
    write_cmos_sensor(0x0f30, 0x6925);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_txd_slim_video_hi556[] = {
    0x0b0a, 0x8252,
    0x0f30, 0x6925,
    0x0f32, 0x7067,
    0x004a, 0x0100,
...
#if MULTI_WRITE
    hi556_table_write_cmos_sensor(
        addr_data_pair_txd_slim_video_hi556,
        sizeof(addr_data_pair_txd_slim_video_hi556) /
        sizeof(kal_uint16));
#else
...
extern unsigned int Hi556_read_region(struct i2c_client *client, unsigned int addr,unsigned char *data,unsigned int size);
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if (deviceInfo_register_value == 0x00) {
                    register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_HI556_TXD, imgsensor_info.module_id);
