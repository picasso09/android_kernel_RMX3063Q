...
/*
 * FP5510EAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "FP5510EAF_DRV"
...
#ifndef VENDOR_EDIT
/*Cong.zhou@ODM_HD 20190521 add for moto hit*/
#define VENDOR_EDIT
#endif
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd5[2] = {(char)(0xF2), (char)(0x28)};
...
/* ////////////////////////////////////////////////////////////// */
long FP5510EAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int FP5510EAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int FP5510EAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int FP5510EAF_GetFileName(unsigned char *pFileName)
{
