...
#define ILI9882N_TXD_INX_MN228_LCM_ID (0x11)
#include "disp_dts_gpio.h"
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x00, 174,{}},
	{0x80, 1, {0x01}},
...
/* Liyan@ODM.HQ.Multimedia.LCM 2019/09/19 modified for backlight remapping */
	...
	register_device_proc("lcd", "ili9882n_mn228", "TXD_INX");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    LCM_LOGI("%s,ili9882n_txd_inx_mn228 backlight: level = %d\n", __func__, level);
	if(level == 3768) {
		level = 3767;
	}
	if (level == 0){
...
LCM_DRIVER ili9882n_hdp_dsi_vdo_txd_inx_mn228_zal3251_lcm_drv = {
    .name = "ili9882n_mn228_txd_inx",
