 ...
 ** ODM_HQ_EDIT
 ** File: ili9882h_hdp_dsi_vdo_ls_panda_zal3251.c
...
#define LOG_TAG "LCM_ILI9882H_LS_PANDA"
...
#define ILI9882H_LS_PANDA_LCM_ID (0x30)
#include "disp_dts_gpio.h"
...
//    params->density = LCM_DENSITY;
	...
	register_device_proc("lcd", "ili9882h", "LS_PANDA");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    LCM_LOGI("%s,ili9882h_ls backlight: level = %d\n", __func__, level);
	if(level == 3768) {
		level = 3767;
	}
	if (level == 0){
...
LCM_DRIVER ili9882h_hdp_dsi_vdo_ls_panda_zal3251_lcm_drv = {
    .name = "ili9882h_ls_panda",
