 ...
 ** ODM_HQ_EDIT
 ** File: ili9882n_hdp_dsi_vdo_truly_truly_zal3251.c
...
#define LOG_TAG "LCM_ILI9882N_TRULY_TRULY"
...
#define ILI9882N_TRULY_TRULY_LCM_ID (0x60)
#include "disp_dts_gpio.h"
...
/* Liyan@ODM.HQ.Multimedia.LCM 2019/09/19 modified for backlight remapping */
	...
	register_device_proc("lcd", "ili9882n", "TRULY_TRULY");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    LCM_LOGI("%s,ili9882n_truly_truly_mn228 backlight: level = %d\n", __func__, level);
	if(level == 3768) {
		level = 3767;
	}
	if (level == 0){
...
LCM_DRIVER ili9882n_hdp_dsi_vdo_truly_truly_zal3251_lcm_drv = {
    .name = "ili9882n_truly_truly",
