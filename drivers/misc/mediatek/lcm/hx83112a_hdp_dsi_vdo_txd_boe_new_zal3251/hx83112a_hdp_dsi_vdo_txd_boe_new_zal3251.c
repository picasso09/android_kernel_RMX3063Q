 ...
 ** ODM_HQ_EDIT
 ** File: hx83112a_hdp_dsi_vdo_txd_boe_new_zal3251.c
...
#define LOG_TAG "LCM_HX83112A_TXD_BOE_NEW"
...
#define HX83112A_TXD_BOE_NEW_LCM_ID (0x19)
#include "disp_dts_gpio.h"
...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xB4, 27 ,{0x04,0xDF,0x04,0xDF,0x00,0x00,0x08,0xDF,0x00,0x00,0x08,0xDF,0x00,0xFF,0x00,0xFF,
                0x00,0x00,0x0C,0x0F,0x00,0x36,0x08,0x0D,0x0F,0x00,0x36 }},
    {0xBA ,16 ,{0x73,0x23,0x64,0x33,0x33,0x33,0x33,0x11,0x10,0x00,0x00,0x10,0x08,0x3D,0x02,0x76 }},
    {0xC0 , 2 ,{0x22,0x22 }},
    {0xC1 , 1 ,{0x01 }},
    ...
    {0xCC , 1 ,{0x08 }},
    {0xD2 , 2 ,{0x2B,0x2B }},
    {0xD3 ,47 ,{0xC0,0x00,0x00,0x00,0x00,0x01,0x00,0x14,0x14,0x03,0x01,0x11,0x08,0x08,0x08,0x08,
                0x08,0x32,0x10,0x05,0x00,0x00,0x32,0x10,0x0F,0x00,0x0F,0x32,0x10,0x0F,0x00,0x00,
    			0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xEA,0x1C }},
    {0xD5 ,48 ,{0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0xC0,0xC0,
                0xC0,0xC0,0x18,0x18,0x40,0x40,0x18,0x18,0x18,0x18,0x31,0x31,0x30,0x30,0x2F,0x2F,
    			0x01,0x00,0x03,0x02,0x20,0x20,0xC0,0xC0,0xC0,0xC0,0x19,0x19,0x40,0x40,0x25,0x24 }},
    {0xD6 ,48 ,{0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x40,0x40,
                0x40,0x40,0x18,0x18,0x40,0x40,0x18,0x18,0x18,0x18,0x31,0x31,0x30,0x30,0x2F,0x2F,
    			0x02,0x03,0x00,0x01,0x20,0x20,0x40,0x40,0x40,0x40,0x40,0x40,0x19,0x19,0x24,0x25 }},
    {0xD8 ,12 ,{0xAA,0xAA,0xAA,0xAA,0xFF,0xEA,0xAA,0xAA,0xAA,0xAA,0xFF,0xEA }},
    {0xE7 ,25 ,{0x0F,0x0F,0x1E,0x76,0x1E,0x74,0x00,0x50,0x20,0x14,0x00,0x00,0x02,0x02,0x02,0x05,
                0x14,0x14,0x32,0xB9,0x23,0xB9,0x08,0x13,0x69 }},
    {0xBD , 1 ,{0x01 }},
    {0xBF , 4 ,{0x1A,0xBF,0x01,0x0A }},
    {0xB1 , 3 ,{0x64,0x01,0x09 }},
    {0xCB , 3 ,{0x25,0x11,0x01 }},
    {0xC1 ,57 ,{0xFF,0xF9,0xF5,0xF3,0xEC,0xE7,0xE2,0xD7,0xD1,0xCB,0xC5,0xC0,0xBB,0xB5,0xAF,0xA9,
                0xA3,0x9E,0x98,0x8E,0x84,0x7A,0x71,0x68,0x60,0x58,0x50,0x49,0x43,0x3D,0x36,0x2F,
                0x29,0x23,0x1E,0x19,0x13,0x0E,0x0A,0x06,0x03,0x02,0x01,0x01,0x00,0x00,0x2C,0xFE,
                0x57,0xED,0x3E,0x15,0x46,0xA0,0xB0,0x1C,0x40 }},
    {0xD8 ,12 ,{0xAA,0xAA,0xAF,0xFF,0xFF,0xFF,0xAA,0xAA,0xAF,0xFF,0xFF,0xFF }},
    {0xE7 , 8 ,{0x02,0x00,0x6C,0x01,0x6E,0x0E,0x48,0x0F }},
    {0xBD , 1 ,{0x02 }},
    {0xB4 , 9 ,{0x00,0x89,0x12,0x11,0x88,0x12,0x12,0x00,0x53 }},
    {0xC1 ,57 ,{0xFF,0xFB,0xF7,0xF1,0xEC,0xE7,0xE2,0xD7,0xD2,0xCC,0xC6,0xC1,0xBB,0xB5,0xAF,0xA9,
                0xA3,0x9D,0x98,0x8D,0x83,0x7A,0x71,0x67,0x5F,0x57,0x4F,0x49,0x42,0x3C,0x35,0x2F,
                0x29,0x23,0x1E,0x19,0x13,0x0E,0x0A,0x06,0x03,0x02,0x01,0x01,0x00,0x33,0xFB,0xBD,
                0x96,0xF6,0x93,0xBC,0xED,0x50,0xB4,0x6C,0x40 }},
    {0xD8 ,12 ,{0xAA,0xAA,0xAF,0xFF,0xFF,0xFF,0xAA,0xAA,0xAF,0xFF,0xFF,0xFF }},
    {0xE7 ,29 ,{0x00,0x00,0x08,0x40,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
                0x00,0x00,0x00,0x00,0x00,0x00,0x04,0x00,0x70,0x01,0x70,0x02,0x00 }},
    {0xBD ,1  ,{0x03 }},
    {0xD8 ,24 ,{0xAA,0xAA,0xAE,0xBF,0xAA,0xBE,0xAA,0xAA,0xAE,0xBF,0xAA,0xBE,0xAA,0xAA,0xAF,0xFF,
                0xFF,0xFF,0xAA,0xAA,0xAF,0xFF,0xFF,0xFF  }},
    {0xC1 ,57 ,{0xFF,0xFA,0xF6,0xF0,0xEB,0xE6,0xE1,0xD6,0xD1,0xCB,0xC5,0xBF,0xB9,0xB3,0xAD,0xA8,
                0xA2,0x9C,0x96,0x8C,0x82,0x79,0x70,0x67,0x5F,0x57,0x4F,0x48,0x42,0x3C,0x35,0x2F,
                0x29,0x23,0x1E,0x19,0x13,0x0E,0x0A,0x06,0x03,0x02,0x01,0x01,0x00,0x33,0xE5,0x02,
                0xE8,0x1E,0x95,0x6B,0xDD,0x60,0xB4,0x6D,0x00}},
    {0xBD , 1 ,{0x00 }},
    {0xCF , 4 ,{0x00,0x14,0x00,0xC0 }},
    {0xE4 ,26 ,{0x2D,0x01,0x2C,0x00,0x08,0x00,0x10,0x08,0x04,0x04,0x00,0x80,0x40,0xE8,0x34,0x70,
                0x98,0xC8,0xFF,0xA5,0xFF,0xEF,0x10,0x38,0x10,0x00 }},
    {0xBD , 1 ,{0x01 }},
    {0xCB , 3 ,{0x25,0x11,0x01 }},
    {0xBD , 1 ,{0x00 }},
    {0x11 , 1 ,{0x00 }},
...
//    params->density = LCM_DENSITY;
    ...
    params->dsi.horizontal_frontporch = 196;
...
/* Liyan@ODM.HQ.Multimedia.LCM 2019/09/19 modified for backlight remapping */
	...
	register_device_proc("lcd", "hx83112a", "TXD_BOE_NEW_FIVES");
...
#ifdef ODM_HQ_EDIT
/* wangcheng@ODM.Multimedia.LCD  2020/10/09 add for lcd shutdown power control  start */
...
/* wangcheng@ODM.Multimedia.LCD  2020/10/09 add for lcd shutdown power control  end */
#endif
...
static void lcm_resume(void)
{
	...
	size = sizeof(init_setting_vdo) /
		sizeof(struct LCM_setting_table);
	push_table(NULL, init_setting_vdo, size, 1);
/* Xiaojun.Lv@MM.Lcd.Driver, 2020/12/04, Add for 3level cabc feature */
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    LCM_LOGI("%s,hx83112a_txd_boe_new backlight: level = %d\n", __func__, level);
	if(level == 3768) {
		level = 3767;
	}
	if (level == 0){
...
LCM_DRIVER hx83112a_hdp_dsi_vdo_txd_boe_new_zal3251_lcm_drv = {
    .name = "hx83112a_txd_boe_new_fives",
