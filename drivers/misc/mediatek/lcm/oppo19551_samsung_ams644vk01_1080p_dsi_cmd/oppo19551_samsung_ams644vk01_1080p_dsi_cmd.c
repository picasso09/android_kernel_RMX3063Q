...
#define SEED_PARAMETER {0xCA,0x00,0x00,0x14,0xD6,0x00,0x0E,0x09,0xF0,0x28,0xFC,0xE0,0xF8,0x09,0xE5,0xF0,0xEE,0x01,0xFF,0xFF,0xFF}
...
static struct LCM_setting_table lcm_aod_in_setting[] = {
	...
	{0xF0, 2, {0x5A,0x5A}},
	{0xB0, 1, {0x02}},
	{0xB1, 21, {0xCA,0x00,0x00,0x14,0xD6,0x00,0x0E,0x09,0xF0,0x28,0xFC,0xE0,0xF8,0x09,0xE5,0xF0,0xEE,0x01,0xFF,0xFF,0xFF}},
	{0xB1, 2, {0x00,0x00}},
	{0xF0, 2, {0xA5,0xA5}},
	/* Seed Tcs On */
	{0xF0, 2, {0x5A,0x5A}},
