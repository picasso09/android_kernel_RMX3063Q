 ...
 ** ODM_HQ_EDIT
 ** File: ft8006saa_hdp_dsi_vdo_truly_truly_zal3251.c
 ...
 **  1.0           2021/04/06   wangcheng@ODM_HQ   Source file for LCD driver
 ********************************************/

#define LOG_TAG "LCM_FT8006SAA_TRULY_TRULY"
...
#define FT8006SAA_TRULY_TRULY_LCM_ID (0x69)
#include "disp_dts_gpio.h"
...
//#ifdef VENDOR_EDIT
/*Zhibin.Pan@MM.Display.LCD.Config, 2020/12/04. Add for TP common code */
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x90,16,{0x00,0x24,0x42,0x0A,0xE3,0x91,0xA4,0xF0,0xAE,0xB9,0x66,0x20,0x19,0xA1,0x26,0x00}},
	...
	{0x90,2,{0x15,0x00}},
	{0x41,2,{0x5A,0x0C}},
	{0x80,16,{0xBA,0x68,0x68,0x01,0x32,0x74,0xD0,0x07,0x00,0x60,0x15,0x00,0x50,0x15,0x56,0x51}},
	...
	{0x41,2,{0x5A,0x0F}},
	{0x80,16,{0xBD,0x07,0x70,0xC0,0x12,0x08,0x64,0x08,0x52,0x51,0x58,0x49,0x03,0x52,0x4C,0x4C}},
	...
	{0x41,2,{0x5A,0x14}},
	{0x80,16,{0x01,0x02,0x41,0x36,0xE9,0xEF,0xF7,0xFB,0xFD,0x7E,0x01,0x00,0x00,0x90,0xC5,0x87}},
	{0x90,16,{0xC7,0x3C,0x20,0x36,0x3C,0xE6,0x01,0x71,0xE1,0x31,0x0F,0x88,0x09,0x8F,0x79,0xC0}},
	{0xA0,16,{0x36,0x98,0xCD,0x04,0x36,0xC2,0x6C,0x26,0x00,0xF8,0x82,0xB5,0xE2,0xF7,0x47,0x00}},
	{0xB0,16,{0xD8,0x89,0xDF,0x1F,0x01,0x00,0x00,0x00,0x00,0x1C,0xB2,0x21,0x2B,0x00,0x40,0xA1}},
	{0xC0,16,{0x50,0x78,0x07,0x1E,0xF3,0x80,0x51,0x1C,0x6F,0xC0,0x63,0x1E,0x30,0x8A,0xE3,0x05}},
	{0xD0,16,{0x78,0xCC,0x03,0x46,0x71,0xBC,0x02,0x8F,0x79,0xC0,0x28,0x8E,0x77,0xE1,0x31,0x0F}},
	{0xE0,16,{0x18,0xC5,0xF1,0x26,0x3C,0xE6,0x01,0xA3,0x38,0xDE,0x83,0xC7,0x3C,0x60,0x14,0xC7}},
	{0xF0,16,{0x5B,0xF0,0x98,0x07,0x8C,0xE2,0x18,0x01,0xBF,0xDF,0x08,0x00,0x00,0x00,0x00,0x00}},
	{0x41,2,{0x5A,0x15}},
	{0x80,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x52,0xD9,0xE0,0xF7}},
	{0x90,16,{0xA3,0x00,0x25,0x5B,0xC5,0xA8,0xC5,0x03,0x00,0x00,0x5C,0x31,0x6A,0xF1,0x41,0x8C}},
	{0xA0,16,{0x78,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x13,0x00,0xF0,0x00,0x14,0xCC,0x34,0x41}},
	{0xC0,16,{0x13,0xA2,0x54,0x15,0x41,0x18,0x06,0x00,0x08,0xA2,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6}},
	{0xD0,16,{0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0x5B,0xCD,0x34}},
	{0xE0,16,{0x41,0x53,0xB2,0x54,0x55,0x51,0x1C,0x47,0x10,0x0C,0xA3,0x6D,0xDB,0xB6,0x6D,0xDB}},
	...
	{0x41,2,{0x5A,0x24}},
	{0x80,16,{0x00,0x03,0x00,0xFF,0xFF,0x20,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x16,0x92}},
...
//    params->density = LCM_DENSITY;
    ...
    params->dsi.vertical_frontporch = 135;
...
/* Liyan@ODM.HQ.Multimedia.LCM 2019/09/19 modified for backlight remapping */
	...
	register_device_proc("lcd", "ft8006saa", "TRULY_TRULY");
...
static void lcm_resume_power(void)
{
	...
	//#ifdef VENDOR_EDIT
	/*Zhibin.Pan@MM.Display.LCD.Config, 2020/12/04. Add for sequence, tp_rst/lcd_rst keep low while vsp/vsn power on when resume */
...
static void lcm_resume(void)
{
	...
	LCM_LOGI("%s: enter\n", __func__);
	//#ifndef VENDOR_EDIT
	/*Zhibin.Pan@MM.Display.LCD.Config, 2020/12/04. Remove for sequence, tp_rst should before lcd_rst when resume */
	/* disp_dts_gpio_select_state(DTS_GPIO_STATE_LCM_RST_OUT0);
	MDELAY(5);
	disp_dts_gpio_select_state(DTS_GPIO_STATE_LCM_RST_OUT1);
	MDELAY(10); */
...
LCM_DRIVER ft8006saa_hdp_dsi_vdo_truly_truly_zal3251_lcm_drv = {
    .name = "ft8006saa_truly_truly",
