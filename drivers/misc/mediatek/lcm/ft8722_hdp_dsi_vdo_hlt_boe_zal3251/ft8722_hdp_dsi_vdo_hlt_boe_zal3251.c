...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x00,1,{0x80}},
	{0xCA,12,{0xEA,0xD6,0xC4,0xB7,0xAD,0xA3,0x9C,0x96,0x90,0x8B,0x87,0x83}},
	{0x00,1,{0x90}},
	{0xCA,9,{0xFC,0xA4,0xAF,0xD9,0xFF,0xAD,0xD6,0x32,0xF5}},
	{0x00,1,{0xA0}},
	{0xCA,3,{0x06,0x06,0x06}},
	{0x00,1,{0x00}},
...
static void lcm_resume_power(void)
{
	...
	//#ifdef VENDOR_EDIT
	/*Zhibin.Pan@MM.Display.LCD.Config, 2021/03/26. Add for resume sequence, two lcd_rst and tp_rst keep high */
	disp_dts_gpio_select_state(DTS_GPIO_STATE_LCM_RST_OUT0);
	MDELAY(5);
	//#endif
