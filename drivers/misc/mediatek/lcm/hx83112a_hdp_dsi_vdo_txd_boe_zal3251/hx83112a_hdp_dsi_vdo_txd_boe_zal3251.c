 ...
 ** ODM_HQ_EDIT
 ** File: hx83112a_hdp_dsi_vdo_txd_boe_zal3251.c
...
#define LOG_TAG "LCM_HX83112A_TXD_BOE"
...
#define HX83112A_TXD_BOE_LCM_ID (0x17)
#include "disp_dts_gpio.h"
...
/* Liyan@ODM.HQ.Multimedia.LCM 2019/09/19 modified for backlight remapping */
	...
	register_device_proc("lcd", "hx83112a", "TXD_BOE_FIVES");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    LCM_LOGI("%s,hx83112a_txd_boe backlight: level = %d\n", __func__, level);
	if(level == 3768) {
		level = 3767;
	}
	if (level == 0){
...
LCM_DRIVER hx83112a_hdp_dsi_vdo_txd_boe_zal3251_lcm_drv = {
    .name = "hx83112a_txd_boe_fives",
