 ...
 ** ODM_HQ_EDIT
 ** File: ili9882f_hdp_dsi_vdo_hlt_boe_zal3251.c
...
#define LOG_TAG "LCM_ILI9882F_HLT_BOE"
...
#define ILI9882F_HLT_BOE_LCM_ID (0x28)
#include "disp_dts_gpio.h"
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x00, 1, {0x42}},     //40->41 line_miss  Ver:F
	{0x01, 1, {0x11}},
	{0x02, 1, {0x00}},
	{0x03, 1, {0x00}},
	{0x05, 1, {0x00}},
	{0x08, 1, {0x8d}},    //87->8d line_miss   Ver:F
	{0x09, 1, {0x08}},
	{0x0a, 1, {0x30}},
	{0x0b, 1, {0x00}},
	{0x0c, 1, {0x00}},
	{0x0d, 1, {0x00}},
	{0x0e, 1, {0x0A}},   //00->0a subFlk H_wen   Ver:F
	{0x0f, 1, {0x0A}},    //00->0a subFlk H_wen   Ver:F
	{0x29, 1, {0x5F}},
	{0x2A, 1, {0x48}},
	{0x2B, 1, {0x89}},
	{0x31, 1, {0x07}},
	...
	{0xEA, 1, {0x0F}},
	{0xE7, 1, {0x54}},
	{0xC1, 1, {0x2F}},        //Add TP TURN1 Ver:F
	{0xC2, 1, {0x4C}},        //Add TP TURN3 Ver:F
	{0xB0, 1, {0x00}},        //Add TP TURN1 Ver:F
	...
	{0x03, 1, {0x00}},    // Vcom
	{0x04, 1, {0x7E}},    // Vcom    D7/-1V; 81h   Ver:F
	{0x50, 1, {0x0F}},    // VGH 2x
	{0x58, 1, {0x61}},    // VGL 2x
	{0x63, 1, {0x8D}},     // GVDDN = -5.3V
	{0x64, 1, {0x8D}},     // GVDDP = 5.3V
	{0x68, 1, {0x15}},    // VGHO = 8V
	{0x69, 1, {0x1B}},     // VGH = 9V
	{0x6A, 1, {0x51}},     // VGLO = -8V
	{0x6B, 1, {0x43}},    // VGL = -9V
	...
	{0xC1, 1, {0x16}},    // NL = 1600
	// Gamma Register
	{0xFF, 3, {0x98, 0x82, 0x08}},	// Ver:F
	{0xE0, 27, {0x00,0x24,0x75,0xAA,0xEB,0x55,0x20,0x49,0x7A,0xA1,0xA9,0xDE,0x0F,0x3B,0x65,0xEA,0x90,0xC3,0xE3,0x0A,0xFF,0x2B,0x55,0x87,0xB1,0x03,0xEC}},
	{0xE1, 27, {0x00,0x24,0x75,0xAA,0xEB,0x55,0x20,0x49,0x7A,0xA1,0xA9,0xDE,0x0F,0x3B,0x65,0xEA,0x90,0xC3,0xE3,0x0A,0xFF,0x2B,0x55,0x87,0xB1,0x03,0xEC}},
	...
	{0xAB, 1, {0xE0}},
	// TP Modulation
	{0xFF, 3, {0x98, 0x82, 0x0C}},
	{0x00, 1, {0x1E}},
	{0x01, 1, {0x4C}},     //TP VER:F
	{0x02, 1, {0x1E}},     //TP VER:F
	{0x03, 1, {0x4F}},     //TP VER:F
	{0x04, 1, {0x1E}},
	{0x05, 1, {0x4B}},     //TP VER:F
	{0x06, 1, {0x1E}},
	{0x07, 1, {0x46}},    //TP VER:F
	{0x08, 1, {0x1E}},
	{0x09, 1, {0x49}},     //TP VER:F
	{0x0A, 1, {0x1E}},    //TP VER:F
	{0x0B, 1, {0x47}},     //TP VER:F
	{0x0C, 1, {0x1E}},    //TP VER:F
	{0x0D, 1, {0x48}},    //TP VER:F
	{0x0E, 1, {0x1E}},     //TP VER:F
	{0x0F, 1, {0x50}},     //TP VER:F
	{0x10, 1, {0x1E}},     //TP VER:F
	{0x11, 1, {0x4E}},     //TP VER:F
	{0x12, 1, {0x1E}},     //TP VER:F
	{0x13, 1, {0x4D}},     //TP VER:F   4B to 4D
	{0x14, 1, {0x1E}},    //TP VER:F
	{0x15, 1, {0x4A}},     //TP VER:F
	{0x16, 1, {0x1F}},
	{0x17, 1, {0x59}},
	{0x18, 1, {0x1E}},
	{0x19, 1, {0x4C}},
	...
	{0x46, 1, {0xD1}},
	{0x4D, 1, {0x8C}},
	{0xD0, 1, {0x01}},   //TP VER:F
	{0x00, 1, {0xA3}},
	{0x4B, 1, {0x0A}},   //TP VER:F
	{0x07, 1, {0x21}},
	{0xD1, 1, {0x01}},
	{0xD2, 1, {0xF1}},
	{0xD3, 1, {0x60}},
	...
	{0x40, 1, {0x07}},
	{0x02, 1, {0x19}},
	{0xC4, 1, {0x04}},    //ADD TP VER:F
	{0xDD, 1, {0x40}},    //ADD TP VER:F
...
//    params->density = LCM_DENSITY;
	...
	register_device_proc("lcd", "ili9882f", "HLT_BOE");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
    ...
    LCM_LOGI("%s,ili9882f_hlt_boe backlight: level = %d\n", __func__, level);
	if(level == 3768) {
		level = 3767;
	}
	if (level == 0){
...
LCM_DRIVER ili9882f_hdp_dsi_vdo_hlt_boe_zal3251_lcm_drv = {
    .name = "ili9882f_hlt_boe",
