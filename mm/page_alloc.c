...
static int adjust_done[MAX_NR_ZONES];

static void ajust_zone_label(struct zone *zone, int zone_idx)
{
    int i;
    unsigned long prev_base;
    
    if (adjust_done[zone_idx])
        return;
